  ...
  return (
    <MuiThemeProvider>
      ...
      <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-50 font-sans relative overflow-x-clip transition-colors duration-300 pb-20">
        ...
        <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-fuchsia-400/30 dark:bg-fuchsia-600/20 rounded-full blur-[100px] pointer-events-none translate-x-[20%]" />
